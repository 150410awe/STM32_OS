...
namespace kernel::device::RCC {
    namespace {
        ...
        struct clock_enable_register {
            const clock_enable_register& operator=(const type clock) const {
                volatile u32* reg_ptr{ reinterpret_cast<volatile u32*>(address_value) };
                *reg_ptr |= static_cast<u32>(clock);
                return *this;
            }
            constexpr clock_enable_register() = default;
        };
        ...
        struct __AHB1ENR__ : clock_enable_register<AHB1_peripheral_clock, address::AHB1ENR.address_value> {
            ...
            using clock_enable_register<AHB1_peripheral_clock, address::AHB1ENR.address_value>::clock_enable_register;
        };
        struct __AHB2ENR__ : clock_enable_register<AHB2_peripheral_clock, address::AHB2ENR.address_value> {
            ...
            using clock_enable_register<AHB2_peripheral_clock, address::AHB2ENR.address_value>::clock_enable_register;
        };
        struct __AHB3ENR__ : clock_enable_register<AHB3_peripheral_clock, address::AHB3ENR.address_value> {
            ...
            using clock_enable_register<AHB3_peripheral_clock, address::AHB3ENR.address_value>::clock_enable_register;
        };
        struct __APB1ENR__ : clock_enable_register<APB1_peripheral_clock, address::APB1ENR.address_value> {
            ...
            using clock_enable_register<APB1_peripheral_clock, address::APB1ENR.address_value>::clock_enable_register;
        };
        struct __APB2ENR__ : clock_enable_register<APB2_peripheral_clock, address::APB2ENR.address_value> {
            ...
            using clock_enable_register<APB2_peripheral_clock, address::APB2ENR.address_value>::clock_enable_register;
        };
    }
    static constexpr __AHB1ENR__ AHB1ENR {};
    static constexpr __AHB2ENR__ AHB2ENR {};
    static constexpr __AHB3ENR__ AHB3ENR {};
    static constexpr __APB1ENR__ APB1ENR {};
    static constexpr __APB2ENR__ APB2ENR {};
}